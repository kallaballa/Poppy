...
make clean;
AUTOVECTOR=1 WASM=1 make -j info; sed -i "$SEDSTR" src/poppy.js; cp -r src/img src/poppy.html src/poppy-custom.js src/poppy.js src/poppy.wasm src/poppy.worker.js third/cropperjs/dist/cropper.min.* web/
