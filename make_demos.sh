...
../src/poppy -o ../videos/faces.mkv -f60 some1.png some2.png some3.png some1.png
...
../src/poppy -o ../videos/cars.mkv -f60 kindpng1s.png kindpng2s.png kindpng1s.png
...
../src/poppy -o ../videos/browns.mkv -s 1.3 -f60 amir1.jpg amir2.jpg amir1.jpg
...
../src/poppy -o ../videos/catdog.mkv -c1.5 -s2 -f60 cat.png dog.png cat.png
...
../src/poppy -o ../videos/squarecircle.mkv -s8 -f60 circle.png square.png circle.png
...
../src/poppy -o ../videos/numbers.mkv -s10 -f60 1st.png 2nd.png 3rd.png 2nd.png 1st.png
...
../src/poppy -o ../videos/flowers.mkv -s1.5 -f60 flower1.jpg flower2.jpg flower1.jpg
...
../src/poppy -o ../videos/yalefaces.mkv -f60 subject01*.png subject01.glasses.png
