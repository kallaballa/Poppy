...
../src/poppy -t6 -g -o ../videos/catdog.mkv cat.png dog.png cat.png
...
../src/poppy -t10 -g -o ../videos/numbers.mkv 1st.png 2nd.png 3rd.png 2nd.png 1st.png
...
../src/poppy -t4 -g -o ../videos/flowers.mkv flower1.png flower2.png flower1.png
