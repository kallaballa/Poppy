...
../src/poppy -a -e -g -f240 -o ../videos/faces.mkv some2.png img_3.png some1.png
...
../src/poppy -t5 -g -f240 -o ../videos/cars.mkv kindpng1s.png kindpng2s.png kindpng1s.png
...
../src/poppy -t0.5 -d -g -f240 -o ../videos/browns.mkv amir1.jpg amir2.jpg amir1.jpg
...
../src/poppy -t100 -g -f240 -o ../videos/catdog.mkv cat.png dog.png cat.png
...
../src/poppy -t200 -g -f240 -o ../videos/squarecircle.mkv circle.png square.png circle.png
...
../src/poppy -t500 -g -f240 -o ../videos/numbers.mkv 1st.png 2nd.png 3rd.png 2nd.png 1st.png
...
../src/poppy -t10 -g -f240 -o ../videos/flowers.mkv flower1.png flower2.png flower1.png
...
../src/poppy -t1 -g -f240 -o ../videos/yalefaces.mkv subject01*.png subject01.glasses.png
